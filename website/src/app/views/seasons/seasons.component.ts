...
export class SeasonsComponent {
  ...
  private fetchData(seasonId: number, shouldReplaceUrl: boolean = true) {
    ...
    // if (this.showChart && this.seasonData.gauntletInfo.flourish_id) segments.push('chart');
  ...
  //   return `https://flo.uri.sh/visualisation/${this.seasonData.gauntletInfo.flourish_id}/embed`;
  // }
}
